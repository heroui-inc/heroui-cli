...
│  ○ Pages (A Next.js 15 with pages directory template pre-configured with NextUI (v2) and Tailwind CSS.)
...
│  ○ Laravel (A Laravel template pre-configured with NextUI (v2) and Tailwind CSS.)
│
